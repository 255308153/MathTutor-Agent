...
from .assist2017_mapping import build_mapping_artifact, coverage_diagnostics


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build a small canonical ASSIST2017 question/concept mapping artifact."
    )
    parser.add_argument("--q-matrix", required=True, help="Path to ASSIST2017 Q-matrix CSV.")
